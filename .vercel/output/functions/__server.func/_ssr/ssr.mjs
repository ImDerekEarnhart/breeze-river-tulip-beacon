...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Smb5DXPL.mjs");
...
var manifest = {
	"0fcb6008b04db3bc22911f2a05c07db6f6562fa3848791047425f8f1ef6db36c": {
		functionName: "runFlmScenario_createServerFn_handler",
		importer: () => import("./api-CvWijA3K.mjs")
	},
	"2af88fd0e65b35b615d69e45cc893025902a17f41b2501e583baf1f8b098c0be": {
		functionName: "getSystemStatus_createServerFn_handler",
		importer: () => import("./api-CvWijA3K.mjs")
	},
	"2d3f7c6568954469e325f1cf6d9c045c98a81ff3062f94bf2833fe51f2367a03": {
		functionName: "getInfrastructure_createServerFn_handler",
		importer: () => import("./api-CvWijA3K.mjs")
	},
	"37b423fa6e74782f20668ca07397250cef59463613acc5b049d2d9de9b971643": {
		functionName: "probeHodgeform_createServerFn_handler",
		importer: () => import("./api-CvWijA3K.mjs")
	},
	...
	"aa9316d55bfd4fd389945356d6ec15f6fd7b416e2ac9017a19f0b016fa64923a": {
		functionName: "listCorpus_createServerFn_handler",
		importer: () => import("./api-CvWijA3K.mjs")
	},
	"be8dba054b3a4e80704a101077f6e9e2427cfcf14b7f13e88991db4d0b785234": {
		functionName: "runSyntheticHodgeformCase_createServerFn_handler",
		importer: () => import("./api-CvWijA3K.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DYYKjlJ5.mjs").then((n) => n.t),
